...
import { deleteFramework, updateFramework } from "../../redux/framework/framework";
...
const FrameworkSection = ({
    ...
    const { formFramework, handleInputValue, setFormFramework } = FrameworkInitialForm();
    ...
    const handleEditSubmit = (formFramework: any) => (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
